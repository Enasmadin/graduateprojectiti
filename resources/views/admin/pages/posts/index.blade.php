...
@else
       ...
       <div class="table-responsive">
            <table id="datatable" class="table table-striped table-bordered p-0">
             ...
             <td><img class="card-img-top" src="{{ asset('productpic') . '/' . $post->product->product_pic }}"
             ...
             <td>
                ...
                title="edit" style="width: 34px; height: 34px; margin:1px; display: inline-block;"><i class="fa fa-edit" ></i></button>


                <form action="{{ route('admin.posts.destroy', $post->id )}}" method="post" style="width: 34px; height: 34px; margin:1px; display: inline-block;" >
                   @method('DELETE')
                   @csrf
