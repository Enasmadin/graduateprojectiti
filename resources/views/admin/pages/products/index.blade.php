...
<br><br>
   ...
   <td><img class="img-fluid w-25" src="{{ asset('productpic') . '/' . $product->product_pic }}" alt=""></td>
...
<form id="product-delete{{$product->id}}" action="{{ route('admin.products.destroy', $product->id )}}" method="POST"
 class="d-none">
 @csrf
 @method('DELETE')
</form>
...
<div class="modal-body">
    ...
    <div class="col-12">
        ...
        <select id="category" class="form-select form-control  py-2 @error('category_id') is-invalid @enderror"
            name="category_id">
...
<div class="container row">
    ...
    <div class="col-12">
        <lab el for="category" class="form-label text-primary">
            {{ __('اختر تصنيفا') }}</lab>
        <select id="category" class="form-select overflow-hidden py-2 form-control  @error('category') is-invalid @enderror" name="category_id">
