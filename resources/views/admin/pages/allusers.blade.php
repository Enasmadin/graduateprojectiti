...
<div class="modal-dialog" role="document">
    ...
    <form action="{{ route('admines.update', $user->id) }}" method="POST" enctype="multipart/form-data" >
                    @method('PUT')
                    @csrf
...
<div class="row">
   ...
   <div class="form-outline flex-fill mb-0">
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                        <img class="card-img-top" src="{{ asset('profilepic') . '/' . $user->profile_pic }}" alt="">
                                                ...
                                                <input class="form-control @error('profile_pic') is-invalid @enderror"
                                                    type="file" name="profile_pic" id="profile_pic" value="{{ $user->profile_pic ? asset('profilepic'). '/'. $user->profile_pic  : old('profile_pic') }}" />
                                                @error('profile_pic')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                            <img class="card-img-top" src="{{ asset('nationalidpic') . '/' . $user->national_id_first_pic }}" alt="">
                                                <label class="form-label"
                                                ...
                                                <input
                                                    ...
                                                    id="national_id_first_pic" value="{{ $user->national_id_first_pic ? asset('nationalidpic'). '/'. $user->national_id_first_pic  : old('national_id_first_pic') }}" />
                                                ...
                                                <div class="form-outline flex-fill mb-0">
                                                <img class="card-img-top" src="{{ asset('nationalidpic') . '/' . $user->national_id_second_pic }}" alt="">
                                                    <input
                                                        class="form-control @error('national_id_second_pic') is-invalid @enderror"
                                                        type="file" name="national_id_second_pic"
                                                        id="national_id_second_pic"  value="{{ $user->national_id_second_pic ? asset('nationalidpic'). '/'. $user->national_id_second_pic  : old('national_id_second_pic') }}"/>
...
<div class="d-flex flex-row align-items-center mb-4">
    <div class="form-check form-check-inline mb-0 me-4">
                                                <select class="form-select" name="city"  value="{{ $user->city ? $user->city : old('city') }}">
...
<div class="d-flex flex-row align-items-center mb-4">
    <div class="form-check form-check-inline mb-0 me-4">
        <input class="form-check-input @error('gender') is-invalid @enderror"
            type="radio" name="gender" id="femaleGender" value="female"  {{ $user->gender== 'female' ? 'checked' : '' }}/>
        <label class="form-check-label"
            for="femaleGender">{{ __('Female') }}</label>
    </div>
    <div class="form-check form-check-inline mb-0 me-4">
        <input class="form-check-input @error('gender') is-invalid @enderror"
            type="radio" name="gender" id="maleGender" value="male" {{ $user->gender== 'male' ? 'checked' : '' }} />
        <label class="form-check-label"
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            <div class="form-check form-check-inline mb-0 me-4">
                                                <input class="form-check-input @error('role') is-invalid @enderror"
                                                    type="radio" name="role" id="femaleGender" value="vendor" {{ $user->role== 'vendor' ? 'checked' : '' }}/>
                                                <label class="form-check-label"
                                                    for="femaleGender">{{ __('vendor') }}</label>
                                            </div>
                                            <div class="form-check form-check-inline mb-0 me-4">
                                                <input class="form-check-input @error('gender') is-invalid @enderror"
                                                    type="radio" name="role" id="maleGender" value="delivery"  {{ $user->role== 'delivery' ? 'checked' : '' }}/>
                                                <label class="form-check-label"
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            <div class="form-check form-check-inline mb-0 me-4">
                                                <input class="form-check-input @error('is_admin') is-invalid @enderror"
                                                    type="radio" name="is_admin" id="femaleGender" value="0" {{ $user->is_admin== '0' ? 'checked' : '' }}  />
                                                <label class="form-check-label"
                                                    for="femaleGender">{{ __('No') }}</label>
                                            </div>
                                            <div class="form-check form-check-inline mb-0 me-4">
                                                <input class="form-check-input @error('gender') is-invalid @enderror"
                                                    type="radio" name="is_admin" id="maleGender" value="1" {{ $user->is_admin== '1' ? 'checked' : '' }} />
                                                <label class="form-check-label"
