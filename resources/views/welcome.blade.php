                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12 mt-5 mt-lg-0">
                        ...
                        <div class="avatar-group border-top py-5 mt-5">
                            <img src="{{ asset('hoome/images/avatar/portrait-good-looking-brunette-young-asian-woman.jpg') }}"
                                class="img-fluid avatar-image" alt="">

                            <img src="{{ asset('hoome/images/avatar/happy-asian-man-standing-with-arms-crossed-grey-wall.jpg" class="img-fluid avatar-image avatar-image-left') }}"
                                alt="">

                            <img src="{{ asset('hoome/images/avatar/senior-man-white-sweater-eyeglasses.jpg" class="img-fluid avatar-image avatar-image-left') }}"
                                alt="">

                            <img src="{{ asset('hoome/images/avatar/pretty-smiling-joyfully-female-with-fair-hair-dressed-casually-looking-with-satisfaction.jpg" class="img-fluid avatar-image avatar-image-left') }}"
                                alt="">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="speakers-thumb">
                            <img src="{{ asset('hoome/images/avatar/Screenshot (41).png') }}"
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-6 col-12">
                                <div class="speakers-thumb speakers-thumb-small">
                                    <img src="{{ asset('hoome/images/avatar/Screenshot (42).png') }}"
                            ...
                            <div class="col-lg-3 col-md-6 col-12">
                                <div class="speakers-thumb speakers-thumb-small">
                                    <img src="{{ asset('hoome/images/avatar/Screenshot (43).png') }}"
                                        class="img-fluid speakers-image  spekers-s" alt="">

                                    <div class="speakers-info">
                                        <h5 class="speakers-title mb-0"> third step </h5>

                                        <p class="speakers-text mb-0"> If you are registered as a conductor, you can
                                            make a comment on the order that you can make </p>
                            ...
                            <div class="col-lg-3 col-md-6 col-12">
                                <div class="speakers-thumb speakers-thumb-small">
                                    <img src="{{ asset('hoome/images/avatar/Screenshot (44).png') }}"
                                        class="img-fluid speakers-image  spekers-s" alt="">

                                    <div class="speakers-info">
                                        <h5 class="speakers-title mb-0"> Four step </h5>

                                        <p class="speakers-text mb-0"> If you are registered as a merchant, you can
                                            make a publication and a product</p>
                            ...
                            <div class="col-lg-3 col-md-6 col-12">
                                <div class="speakers-thumb speakers-thumb-small">
                                    ...
                                    <div class="speakers-info">
                                        ...
                                        <p class="speakers-text mb-0"> then you can make feedback for merchant and
                                            merchant for you </p>
