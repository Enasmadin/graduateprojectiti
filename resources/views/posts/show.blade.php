        ...
        <div class="card-body">
          <div class="row">
            <div class="col-12 col-sm-6">
              ...
              <div class="col-12">
                <img src="{{asset('productpic' . '/' . $post->product->product_pic)}}" class="product-image img-fluid w-100" alt="Product Image">
              </div>
            ...
            <div class="col-12 col-sm-6 text-right">
              ...
              <h4 class="text-primary text-center m-4">بيانات الطلبية</h4>
                <div class="mx-4">
                    ...
                    <h6><span class="text-primary">سعر التوصيل المقترح:</span> {{$post->deliver_price}} جنيه مصري</h6>
                </div>
                <hr class="m-4">
                <div>
                ...
                <div>
                    ...
                    <div class="text-center">
                        <img src="{{asset('profilepic/' . $post->user->profile_pic)}}" class="rounded-circle card-img-top w-25">
                    </div>
                    <div class="text-center">
                    <a href="{{route('profiles.show',$post->user->id )}}" class="text-center text-decoration-none"> {{$post->user->name}}</a>
                    </div>
              ...
              <div class="mt-4">
                ...
                <small class="text-danger mx-4">هذا المنشور موجود بالفعل في المنشورات المفضله الخاصه بك</small>
                @else
